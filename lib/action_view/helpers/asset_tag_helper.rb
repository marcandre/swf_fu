...
module ActionView #:nodoc:
  ...
  module Helpers # :nodoc:
    module AssetTagHelper
      ...
      def swf_path(source)
        if defined? SwfTag  # Available since 2.1.1 (http://github.com/rails/rails/commit/900fd6eca9dd97d2341e89bcb27d7a82d62965bf )
          SwfTag.create(self, @controller, source).public_path
        else
